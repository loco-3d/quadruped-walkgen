...
#ifndef QUADRUPED_WALKGEN_DEPRECATED_HH
# define QUADRUPED_WALKGEN_DEPRECATED_HH
...
//  void foo () QUADRUPED_WALKGEN_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar QUADRUPED_WALKGEN_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a QUADRUPED_WALKGEN_DEPRECATED = 0;
//
...
#  define QUADRUPED_WALKGEN_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define QUADRUPED_WALKGEN_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define QUADRUPED_WALKGEN_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! QUADRUPED_WALKGEN_DEPRECATED_HH
