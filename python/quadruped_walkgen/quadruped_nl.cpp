...
void exposeActionQuadrupedNonLinear() {
  bp::class_<ActionModelQuadrupedNonLinear, bp::bases<ActionModelAbstract> >(
      ...
      .def("createData", &ActionModelQuadrupedNonLinear::createData, bp::args("self"), "Create the quadruped action data.")
      ...
      .add_property("forceWeights",
                    ...
                    bp::make_function(&ActionModelQuadrupedNonLinear::set_force_weights), "Weights on the control input : ground reaction forces")
      ...
      .add_property("frictionWeights", bp::make_function(&ActionModelQuadrupedNonLinear::get_friction_weight, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedNonLinear::set_friction_weight) , "Weight on friction cone term")
      .add_property("mu", bp::make_function(&ActionModelQuadrupedNonLinear::get_mu, bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property("min_fz", bp::make_function(&ActionModelQuadrupedNonLinear::get_min_fz_contact, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedNonLinear::set_min_fz_contact) , "dt \n Warning : The model needs to be updated")
      .add_property("max_fz", bp::make_function(&ActionModelQuadrupedNonLinear::get_max_fz_contact, bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property("A",
                    bp::make_function(&ActionModelQuadrupedNonLinear::get_A, bp::return_internal_reference<>()),
                     "get A matrix")
      .add_property("B",
                    bp::make_function(&ActionModelQuadrupedNonLinear::get_B, bp::return_internal_reference<>()),
                     "get B matrix") ;
