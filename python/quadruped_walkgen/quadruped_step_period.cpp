...
void exposeActionQuadrupedStepPeriod() {
  bp::class_<ActionModelQuadrupedStepPeriod, bp::bases<ActionModelAbstract> >(
      ...
      .def("createData", &ActionModelQuadrupedStepPeriod::createData, bp::args("self"), "Create the quadruped action data.")
      ...
      .add_property("symmetry_term", bp::make_function(&ActionModelQuadrupedStepPeriod::get_symmetry_term, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_symmetry_term) , "symmetry term for the foot position heuristic")
      .add_property("centrifugal_term", bp::make_function(&ActionModelQuadrupedStepPeriod::get_centrifugal_term, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_centrifugal_term) , "centrifugal term for the foot position heuristic") 
      .add_property("T_gait", bp::make_function(&ActionModelQuadrupedStepPeriod::get_T_gait, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_T_gait) , "Gait period, used to compute the symmetry term") 
      .add_property("dt_ref", bp::make_function(&ActionModelQuadrupedStepPeriod::get_dt_ref, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_dt_ref) , "dt_ref used on the dt reference : || dt - dt_ref||^2 ")
      .add_property("dt_min", bp::make_function(&ActionModelQuadrupedStepPeriod::get_dt_min, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_dt_min) , "Minimum dt")   
      .add_property("dt_max", bp::make_function(&ActionModelQuadrupedStepPeriod::get_dt_max, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_dt_max) , "Maximum dt") 
      .add_property("dt_weight", bp::make_function(&ActionModelQuadrupedStepPeriod::get_dt_weight, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_dt_weight) , "Weight on the dt reference : || dt - dt_ref||^2 ") 
      .add_property("dt_weight_bound", bp::make_function(&ActionModelQuadrupedStepPeriod::get_dt_bound_weight, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_dt_bound_weight) , "Weight on the dt limit : || dt_min - dt||^2 etc..")
      .add_property("nb_nodes", bp::make_function(&ActionModelQuadrupedStepPeriod::get_nb_nodes, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_nb_nodes) , "Nb of nodes during flying phase") 
      .add_property("vlim", bp::make_function(&ActionModelQuadrupedStepPeriod::get_vlim, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_vlim) , "Speed limit of the x and y foot trajectory") 
      .add_property("speed_weight", bp::make_function(&ActionModelQuadrupedStepPeriod::get_speed_weight, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepPeriod::set_speed_weight) , "Speed limit of the x and y foot trajectory")
         ;
