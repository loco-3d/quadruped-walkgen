...
void exposeActionQuadrupedTime() {
  bp::class_<ActionModelQuadrupedTime, bp::bases<ActionModelAbstract> >(
      ...
      .add_property("centrifugal_term", bp::make_function(&ActionModelQuadrupedTime::get_centrifugal_term, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_centrifugal_term) , "centrifugal term for the foot position heuristic") 
      .add_property("T_gait", bp::make_function(&ActionModelQuadrupedTime::get_T_gait, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_T_gait) , "Gait period, used to compute the symmetry term") 
      .add_property("dt_ref", bp::make_function(&ActionModelQuadrupedTime::get_dt_ref, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_dt_ref) , "To fix the integration time using the cost weight*||u-dt_ref||^2") 
      .add_property("dt_min", bp::make_function(&ActionModelQuadrupedTime::get_dt_min, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_dt_min) , "Lower bound for integration time")  
      .add_property("dt_max", bp::make_function(&ActionModelQuadrupedTime::get_dt_max, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_dt_max) , "Upper bound for integration time")  
      .add_property("dt_weight_cmd", bp::make_function(&ActionModelQuadrupedTime::get_dt_weight_cmd, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_dt_weight_cmd) , "To fix the integration time using the cost dt_weight_cmd*||u-dt_ref||^2") 
      .add_property("dt_weight_bound_cmd", bp::make_function(&ActionModelQuadrupedTime::get_dt_bound_weight_cmd, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedTime::set_dt_bound_weight_cmd) , "Penalisation weight for upper/lower bound of the integration time")  
      .add_property("Cost",
                    bp::make_function(&ActionModelQuadrupedTime::get_cost, bp::return_internal_reference<>()),
