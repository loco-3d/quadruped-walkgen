...
void exposeActionQuadrupedStepTime() {
  bp::class_<ActionModelQuadrupedStepTime, bp::bases<ActionModelAbstract> >(
      ...
      .add_property("symmetry_term", bp::make_function(&ActionModelQuadrupedStepTime::get_symmetry_term, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepTime::set_symmetry_term) , "symmetry term for the foot position heuristic")
      .add_property("centrifugal_term", bp::make_function(&ActionModelQuadrupedStepTime::get_centrifugal_term, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepTime::set_centrifugal_term) , "centrifugal term for the foot position heuristic") 
      .add_property("T_gait", bp::make_function(&ActionModelQuadrupedStepTime::get_T_gait, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepTime::set_T_gait) , "Gait period, used to compute the symmetry term") 
      .add_property("speed_weight", bp::make_function(&ActionModelQuadrupedStepTime::get_speed_weight, bp::return_value_policy<bp::return_by_value>()),
                    bp::make_function(&ActionModelQuadrupedStepTime::set_speed_weight) , "Gait period, used to compute the symmetry term") 
