...
#ifndef BINDINGS_PYTHON_QUADRUPED_WALKGEN_VECTOR_CONVERTER_HPP_
#define BINDINGS_PYTHON_QUADRUPED_WALKGEN_VECTOR_CONVERTER_HPP_
...
struct list_to_vector {
  ...
  list_to_vector& from_python() {
    boost::python::converter::registry::push_back(
        &list_to_vector::convertible, &list_to_vector::construct<Container>,
