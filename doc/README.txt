...
The dynamics need to be updated before each control cycle with update_model (with python binding) since the dynamics depend on the position of the feet in the predicted time horizon.     
